...
dojo.provide("extras.symbol.ArrowLineSymbol");
...
dojo.declare("extras.symbol.ArrowLineSymbol",[esri.symbols.SimpleLineSymbol],{
    ...
    _animateGraphic: function (g, repeat) {
        ...
        dojo.query(".dls-symbol", g.dlsSymbolGroup.rawNode).forEach(function (path) {
        	dojo._base.fx.fadeOut({ node: path, duration: 10 }).play();
        ...
        g.dlsAnimationEnd = dojo.on(g.dlsAnimationChain, "End", dojo._base.lang.hitch(this, function () {
    ...
    stopAnimation: function () {
        ...
        for (var i = 0, len = this.graphics.length; i < len; i++) {
            ...
            if (g.dlsSymbolGroup) {
                dojo.query(".dls-symbol", g.dlsSymbolGroup.rawNode).forEach(function (path) {
                	dojo._base.fx.fadeIn({ node: path, duration: 10 }).play();
                });
